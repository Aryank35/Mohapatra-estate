...
const Footer = () => {
  return (
    <div className='h-fit pt-10 pb-3 '>
        <div className="container flex p-4 justify-between">
            <div className="left w-[46%] flex flex-col justify-center items-center">
                <h1 className='text-2xl font-bold text-orange-400'>MohapatraEstate</h1>
                <p className='text-sm text-gray-400'>Our vision is to make all people the best place to live for them.</p>
            </div>
            <div className="right w-[46%] flex flex-col justify-center items-center">
