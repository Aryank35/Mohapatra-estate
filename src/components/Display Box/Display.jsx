...
const Display = () => {
  return (
    <div className=' h-fit bg-blue-500 rounded-xl flex items-center m-2 md:m-8 py-3 md:py-10 px-4'>
        <div className="container flex flex-col text-white justify-center items-center space-y-9">
            <h1 className='text-2xl font-bold text-center'>Get Started With MohapatraEstate</h1>
