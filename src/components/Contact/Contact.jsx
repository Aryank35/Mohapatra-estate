...
const ContactBox = (props) => {
  return (
    <div className="box flex flex-col border-[3px] w-[45%] p-2">
      ...
      <div className="flex justify-center items-center mt-3">
        <a href={`tel:${props.number}`} target="_blank" rel="call">
          <button className="py-3 flex px-[50px] text-lg text-blue-500 hover:text-white font-semibold items-center bg-[#eeeeff] hover:bg-blue-500 rounded-md">
            {props.btnText}
          </button>
        </a>
      </div>
...
const Contact = () => {
  return (
    <div className="flex p-9 justify-center items-center">
      <div className="Left-container w-[48%] mx-auto my-auto">
        <div className="heading">
          <p className="text-orange-500 font-bold text-2xl">Contact Us</p>
        ...
        <div className="contact-box">
          <div className="box p-2">
            <div className="flex justify-center items-center sm:space-x-3 my-4">
            <ContactBox
              icon={faPhone}
              name="Call"
              number="9337440067"
